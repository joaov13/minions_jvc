...
image_small_agnes_obj = pygame.image.load('data/new_data/objects/small_agnes.png')
image_small_margo_obj = pygame.image.load('data/new_data/objects/small_margo.png')
image_small_judith_obj = pygame.image.load('data/new_data/objects/small_judith.png')
image_clock = pygame.image.load('data/balls/clock.png')
image_2x = pygame.image.load('data/balls/2x.png')
image_potion = pygame.image.load('data/balls/potion.png')
image_big_yellow_minion = pygame.image.load('data/balls/big_yellow.png')
